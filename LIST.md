...
## Список функций 0.3.0 (40+)

Вкладка ЯЙЦА:

- живой список яиц с цветом по редкости и кнопками TP/СТЛ у каждого яйца;
- фильтр редкости (16 чипов, общий для списка, ESP-фильтра и автокражи);
...
- автовылупление (GrowingEggs-кнопки + AskHatch), автосбор дохода (AskCollect);
- дорожка каждые 60с (AskWearStill), автопродажа яиц и питомцев;
- фильтр продажи: НЕ продавать выбранные редкости; пауза между продажами;
...
- WalkSpeed и JumpPower слайдеры со сбросом, бесконечный прыжок, noclip,
  телепорт кликом, Anti-AFK.

Вкладка ТОЧКИ: динамические точки, телепорт на базу.
Вкладка СИСТЕМА: проверка Remotes, поиск Sell-ремоутов, дамп всех Remotes в консоль, FPS-режим.

## Редкости (по вики игры)

Divine, Eternal, Secret, Cosmic, Godly, Brainrot, Monster, Mecha, Mythic, Giant,
Legendary, Epic, Rare, Uncommon, Common (+ Unknown). Яйца ресетятся каждые 5 минут.
...
- [x] автопродажа яиц и питомцев с keep-фильтром (0.3.0);
...
- [ ] проверить сборку 0.3.0 в игре и записать ошибки консоли, если они появятся;
- [ ] подтвердить Sell-ремоуты дампом в консоль и поправить автопродажу;
